ArchivesSpacePublic::Application.routes.draw do
  ...
  scope AppConfig[:public_prefix] do
    ...
    match 'repositories/:repo_id/resources/:id/:format' => 'records#resource_by_format', :via => [:get]
    match 'repositories/:repo_id/digital_objects/:id' => 'records#digital_object', :via => [:get]
    match 'repositories/:repo_id/digital_objects/:id/:format' => 'records#digital_object_by_format', :via => [:get]
