  ...
  Scenario: Resource is created
    Given the user is on the New Resource page
     When the user fills in 'Title'
      ...
      And the user fills in 'Script' with 'Old Hungarian' and selects 'Old Hungarian (Hungarian Runic)' in the 'Languages of Materials' form
     ...
     Then the 'Resource' created message is displayed
      ...
      And the Resource form has the following values
        ...
        | Languages of Materials | Language                | English                         |
        | Languages of Materials | Script                  | Old Hungarian (Hungarian Runic) |
        | Dates                  | Type                    | Single                          |
