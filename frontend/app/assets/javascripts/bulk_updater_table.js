  ...
  var renderTable = function (tree) {
    ...
    tableData.getCellSync = function (i, j) {
      ...
      if (j === 0) {
        ...
        return {
          content:
            "<label class='bulk-updater-checkbox-label'><input data-rowid='" +
            i +
            "' id='item" +
            i +
            "' value='" +
      ...
      var content =
        ...
        '<div><label class="bulk-updater-label" for="item' +
        i +
        '">' +
      ...
      if (filtered_tree[i]['children']) {
        content =
          '<span class="bulk-updater-has-children">' + content + '</span>';
      }
