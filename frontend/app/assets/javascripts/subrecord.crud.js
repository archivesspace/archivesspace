      ...
      var init = function(callback) {
        ...
        var init_subform = function() {
          ...
          var addRemoveButton = function() {
            var removeBtn = $("<button class='btn btn-default btn-xs pull-right subrecord-form-remove' title='Remove sub-record' aria-label='Remove sub-record'><span class='glyphicon glyphicon-remove'></span></button>");
