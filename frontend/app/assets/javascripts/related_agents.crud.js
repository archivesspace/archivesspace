  ...
  $.fn.init_related_agents_form = function() {
    $(this).each(function() {
      ...
      var initRemoveActionForSubRecord = function($subform) {
        var removeBtn = $("<button href='javascript:void(0)' class='btn btn-default btn-xs pull-right subrecord-form-remove' title='Remove sub-record' aria-label='Remove sub-record'><span class='glyphicon glyphicon-remove'></span></button>");
