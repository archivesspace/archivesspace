...
(function () {
  ...
  closest = function () {
    ...
    (x = arguments[0]),
      (vals = 2 <= arguments.length ? slice.call(arguments, 1) : []);
    d = Infinity;
    res = void 0;
  ...
  ScrollBarProxy = (function () {
    function ScrollBarProxy(
      ...
      this.scrollbarMargin = Math.max(
        this.horizontalScrollbar.offsetHeight,
        this.verticalScrollbar.offsetWidth
      );
            ...
            return function (evt) {
              if (evt.button === 1) {
                ...
                _this.container.className =
                  'fattable-body-container fattable-moving';
          ...
          (function (_this) {
            return function (evt) {
              if (_this.dragging) {
                if (
                  evt.toElement == null ||
                  evt.toElement.parentElement.parentElement !== _this.container
                ) {
          ...
          (function (_this) {
            return function (evt) {
              if (evt.button === 1) {
                ...
                _this.headerContainer.className =
                  'fattable-header-container fattable-moving';
          ...
          (function (_this) {
            return function (evt) {
              if (_this.headerDragging) {
                if (
                  evt.toElement == null ||
                  evt.toElement.parentElement.parentElement !==
      ...
      if (this.W > this.horizontalScrollbar.clientWidth) {
        this.maxScrollHorizontal =
          this.W - this.horizontalScrollbar.clientWidth;
      } else {
      ...
      onMouseWheel = (function (_this) {
        return function (evt) {
          ...
          has_scrolled = _this.setScrollXY(
            _this.scrollLeft - deltaX,
            _this.scrollTop - deltaY
          );
          if (has_scrolled) {
  ...
  TableView = (function () {
    TableView.prototype.readRequiredParameter = function (
      parameters,
      k,
      default_value
    ) {
    ...
    function TableView(parameters) {
      ...
      if (
        (' ' + this.container.className + ' ').search(/\sfattable\s/) === -1
      ) {
    ...
    TableView.prototype.getContainerDimension = function () {
      ...
      this.nbColsVisible = Math.min(
        smallest_diff_subsequence(this.columnOffset, this.w) + 2,
        this.columnWidths.length
      );
      return (this.nbRowsVisible = Math.min(
        ((this.h / this.rowHeight) | 0) + 2,
        this.nbRows
      ));
    };
    ...
    TableView.prototype.leftTopCornerFromXY = function (x, y) {
      ...
      j = bound(
        binary_search(this.columnOffset, x),
        0,
        this.nbCols - this.nbColsVisible
      );
      return [i, j];
    };
    ...
    TableView.prototype.setup = function () {
      ...
      for (
        j = n = ref = this.nbColsVisible, ref1 = this.nbColsVisible * 2;
        n < ref1;
        j = n += 1
      ) {
        for (
          i = o = ref2 = this.nbRowsVisible, ref3 = this.nbRowsVisible * 2;
          o < ref3;
          i = o += 1
        ) {
          el = document.createElement('div');
      ...
      for (
        c = p = ref4 = this.nbColsVisible, ref5 = this.nbColsVisible * 2;
        p < ref5;
        c = p += 1
      ) {
        el = document.createElement('div');
      ...
      this.scroll = new ScrollBarProxy(
        this.bodyContainer,
        this.headerContainer,
        this.W,
        this.H,
      ...
      onScroll = (function (_this) {
        return function (x, y) {
          ...
          (ref6 = _this.leftTopCornerFromXY(x, y)),
            (i = ref6[0]),
            (j = ref6[1]);
          _this.display(i, j);
          ref7 = _this.columns;
          for (_ in ref7) {
            col = ref7[_];
            col.style[prefixedTransformCssKey] =
              'translate(' + (col.left - x) + 'px, 0px)';
          }
          ref8 = _this.cells;
          for (_ in ref8) {
            cell = ref8[_];
            cell.style[prefixedTransformCssKey] =
              'translate(' + (cell.left - x) + 'px,' + (cell.top - y) + 'px)';
          }
          clearTimeout(_this.scrollEndTimer);
          _this.scrollEndTimer = setTimeout(
            _this.refreshAllContent.bind(_this),
            200
          );
    ...
    TableView.prototype.refreshAllContent = function (evenNotPending) {
      ...
      results = [];
      for (
        j = n = ref = this.firstVisibleColumn,
          ref1 = this.firstVisibleColumn + this.nbColsVisible;
        n < ref1;
        j = n += 1
      ) {
        ...
        results.push(
          function () {
            ...
            results1 = [];
            for (
              i = o = ref2 = this.firstVisibleRow,
                ref3 = this.firstVisibleRow + this.nbRowsVisible;
              o < ref3;
              i = o += 1
            ) {
              k = i + ',' + j;
    ...
    TableView.prototype.moveX = function (j) {
      ...
      for (offset_j = n = 0, ref = dj; n < ref; offset_j = n += 1) {
        ...
        for (
          i = o = ref1 = last_i, ref2 = last_i + this.nbRowsVisible;
          o < ref2;
          i = o += 1
        ) {
          k = i + ',' + orig_j;
    ...
    TableView.prototype.moveY = function (i) {
      ...
      for (offset_i = n = 0, ref = di; n < ref; offset_i = n += 1) {
        ...
        for (
          j = o = ref1 = last_j, ref2 = last_j + this.nbColsVisible;
          o < ref2;
          j = o += 1
        ) {
          k = orig_i + ',' + j;
