class ClassificationsController < ApplicationController
  ...
  def show
    ...
    if params[:inline]
      ...
      return render :partial => "classifications/show_inline", :formats => [:html], :handlers => [:erb]
    end
  ...
  def new
    ...
    return render :partial => "classifications/new_inline", :formats => [:html], :handlers => [:erb] if params[:inline]
  end
  ...
  def edit
    ...
    if params[:inline]
      @classification = JSONModel(:classification).find(params[:id], find_opts)
      return render :partial => "classifications/edit_inline", :formats => [:html], :handlers => [:erb]
    end
