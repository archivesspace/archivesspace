class AssessmentsController < ApplicationController
  ...
  def create
    handle_crud(:instance => :assessment,
                ...
                :on_valid => ->(id) {
                    flash[:success] = t("assessment._frontend.messages.created", JSONModelI18nWrapper.new(:assessment => @assessment))
  ...
  def update
    handle_crud(:instance => :assessment,
                ...
                :on_valid => ->(id) {
                  flash[:success] = t("assessment._frontend.messages.updated", JSONModelI18nWrapper.new(:assessment => @assessment))
  ...
  def delete
    ...
    flash[:success] = t("assessment._frontend.messages.deleted", JSONModelI18nWrapper.new(:assessment => assessment))
