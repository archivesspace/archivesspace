class AccessionsController < ApplicationController
  ...
  def show
    ...
    flash[:info] = t("accession._frontend.messages.suppressed_info", JSONModelI18nWrapper.new(:accession => @accession)) if @accession.suppressed
  end
  ...
  def new
    ...
    if params[:accession_id]
      ...
      if acc
        ...
        flash.now[:info] = t("accession._frontend.messages.spawned", JSONModelI18nWrapper.new(:accession => acc))
  ...
  def create
    handle_crud(:instance => :accession,
                ...
                :on_valid => ->(id) {
                    flash[:success] = t("accession._frontend.messages.created", JSONModelI18nWrapper.new(:accession => @accession))
  ...
  def update
    handle_crud(:instance => :accession,
                ...
                :on_valid => ->(id) {
                  flash[:success] = t("accession._frontend.messages.updated", JSONModelI18nWrapper.new(:accession => @accession))
                  if @accession["is_slug_auto"] == false &&
                     @accession["slug"] == nil &&
                     params["accession"] &&
                     params["accession"]["is_slug_auto"] == "1"
  ...
  def suppress
    ...
    flash[:success] = t("accession._frontend.messages.suppressed", JSONModelI18nWrapper.new(:accession => accession))
    redirect_to(:controller => :accessions, :action => :show, :id => params[:id])
  end
  ...
  def unsuppress
    ...
    flash[:success] = t("accession._frontend.messages.unsuppressed", JSONModelI18nWrapper.new(:accession => accession))
    redirect_to(:controller => :accessions, :action => :show, :id => params[:id])
  end
  ...
  def delete
    ...
    flash[:success] = t("accession._frontend.messages.deleted", JSONModelI18nWrapper.new(:accession => accession))
