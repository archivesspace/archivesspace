...
module ExportHelper
  ...
  # Handles header mapping and field transformations for Top ContainerCSV exports
  class CSVMappingConverter
      ...
      @header_mappings ||= begin
        {
          ...
          'location_profile_display_string_u_sstr'  => I18n.t('search.top_container_mgmt.location_profile',      :default => 'Location Profile')
        }
      end
    end
    ...
    FIELD_NAME_MAPPINGS = {
      ...
      'location_profile'      => 'location_profile_display_string_u_sstr'
    }.freeze
