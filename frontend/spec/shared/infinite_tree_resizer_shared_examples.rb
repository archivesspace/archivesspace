...
RSpec.shared_context 'infinite tree resizer page setup' do
  before do
...
RSpec.shared_examples 'resizing the tree pane' do
  shared_examples 'persisting tree height across page visits' do
  ...
  shared_examples 'maximizing the tree pane' do
        it 'is maximized' do
  ...
  shared_examples 'minimizing the tree pane' do
        it 'is minimized' do
  ...
  shared_examples 'changing height with a keyboard step' do |key, delta|
  ...
  describe 'handle' do
    ...
    describe 'mouse drag' do
      ...
      context 'after resizing the tree' do
        ...
        it_behaves_like 'persisting tree height across page visits'
      end
    end

    describe 'keyboard controls' do
      context 'small step keys' do
        include_examples 'changing height with a keyboard step', :arrow_up, 10
        include_examples 'changing height with a keyboard step', :arrow_right, 10
        include_examples 'changing height with a keyboard step', :arrow_down, -10
        include_examples 'changing height with a keyboard step', :arrow_left, -10
      end

      context 'large step keys' do
        describe 'PageUp' do
          include_examples 'changing height with a keyboard step', :page_up, 50
        end

        describe 'PageDown' do
          before { @handle.send_keys(:page_up) }
          include_examples 'changing height with a keyboard step', :page_down, -50
        end
      end
  ...
  describe 'toggle' do
    ...
    describe 'click' do
      context 'when toggled on' do
        ...
        it_behaves_like 'maximizing the tree pane'
      end
      ...
      context 'when toggled off' do
        ...
        it_behaves_like 'minimizing the tree pane'
      end
