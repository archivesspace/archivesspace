...
describe 'Tree toolbar action matrix', js: true do
  ...
  it 'shows resource-root actions' do
    ...
    expect_toolbar_to_exclude('Add Sibling', 'Add Duplicate', 'Transfer')
  end
  ...
  it 'shows archival object actions when an archival object node is selected' do
    ...
    expect_toolbar_to_include('Add Child', 'Add Sibling', 'Add Duplicate', 'Load via Spreadsheet', 'Rapid Data Entry', 'Transfer', 'Auto-Expand All', 'Collapse Tree')
  end
  ...
  it 'shows digital object root and component actions' do
    ...
    expect_toolbar_to_exclude('Load via Spreadsheet', 'Transfer', 'Auto-Expand All', 'Collapse Tree', 'Add Sibling', 'Add Duplicate')

    click_on component.title
    expect_toolbar_to_include('Add Child', 'Add Sibling', 'Rapid Data Entry')
    expect_toolbar_to_exclude('Load via Spreadsheet', 'Transfer', 'Add Duplicate')
  end
  ...
  it 'shows classification root and term actions' do
    ...
    expect_toolbar_to_exclude('Load via Spreadsheet', 'Transfer', 'Auto-Expand All', 'Collapse Tree', 'Add Sibling', 'Add Duplicate', 'Rapid Data Entry')

    click_on term.title
    expect_toolbar_to_include('Add Child', 'Add Sibling')
    expect_toolbar_to_exclude('Load via Spreadsheet', 'Transfer', 'Add Duplicate', 'Rapid Data Entry')
  end
end
