...
describe 'Infinite Tree Move', js: true do
  ...
  context 'Digital Objects' do
    include_context 'infinite tree reorder hierarchy setup', DIGITAL_OBJECT_REORDER_CONFIG

    it_behaves_like 'infinite tree reorder toggle'
    it_behaves_like 'infinite tree reorder move parity'
  end

  context 'Classifications' do
    include_context 'infinite tree reorder hierarchy setup', CLASSIFICATION_REORDER_CONFIG
