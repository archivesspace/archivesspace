...
require_relative '../../locale_utils/locale_file_processor'
require 'tempfile'
require 'fileutils'

RSpec.describe LocaleUtils::LocaleFileProcessor do
  ...
  describe '#initialize' do
    it 'creates a LocaleFileProcessor with directory list' do
