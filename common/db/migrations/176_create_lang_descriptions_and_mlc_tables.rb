...
Sequel.migration do
  up do
    create_table(:language_and_script_of_description) do
      ...
      Integer :resource_id,  :null => true, index: true
      Integer :accession_id, :null => true, index: true
      Integer :digital_object_id, :null => true, index: true
      apply_mtime_columns
    end
    ...
    alter_table(:resource_mlc) do
      ...
      add_index([:resource_id, :language_id, :script_id], :unique => true, :name => 'resource_mlc_res_lang_script_uniq')
    end
    ...
    alter_table(:accession_mlc) do
      ...
      add_index([:accession_id, :language_id, :script_id], :unique => true, :name => 'accession_mlc_acc_lang_script_uniq')
    end
    ...
    alter_table(:archival_object_mlc) do
      ...
      add_index([:archival_object_id, :language_id, :script_id], :unique => true, :name => 'archival_object_mlc_ao_lang_script_uniq')
    end
    ...
    alter_table(:digital_object_mlc) do
      ...
      add_index([:digital_object_id, :language_id, :script_id], :unique => true, :name => 'digital_object_mlc_do_lang_script_uniq')
    end
    ...
    alter_table(:digital_object_component_mlc) do
      ...
      add_index([:digital_object_component_id, :language_id, :script_id], :unique => true, :name => 'digital_object_component_mlc_doc_lang_script_uniq')
    end
