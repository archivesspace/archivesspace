...
Sequel.migration do
  ...
  up do
    ...
    create_enum("maintenance_status_enum", ["new", "upgraded", "revised_corrected", "derived", "deleted", "cancelled_obsolete", "deleted_split", "deleted_replaced"])
		...
		create_editable_enum("source_enum", ["naf", "snac", "local"])
		create_editable_enum("identifier_type_enum", ["loc", "lac", "local", "other_unmapped"])
		create_editable_enum("agency_code_type_enum", ["oclc", "local"])
