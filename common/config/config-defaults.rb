...
# NOTE: As of release 2.5.2, these deprecated settings should be set in the Staff User interface
# Using the System menu in the staff user interface, select Manage OAI-PMH Settings
# and these three settings are at the top of the page in the General Settings section
# These settings will be removed from this file when version 2.6.0 is released
