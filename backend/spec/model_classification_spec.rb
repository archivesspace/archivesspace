...
describe 'Classification models' do
  ...
  it "allows a classification to be created" do
    expect(classification.titles[0].title).to eq("top-level classification")
  ...
  it "allows a tree of classification_terms to be created" do
    ...
    expect(classification.tree['children'].first['title']).to eq(term.titles[0].title)
    ...
    expect(classification.tree['children'][0]['children'][0]['title']).to eq(second_term.titles[0].title)
  end
    ...
    describe "slug autogen enabled" do
      describe "by name" do
        ...
        it "autogenerates a slug via title" do
          ...
          expected_slug = clean_slug(classification.titles[0].title)
