...
require_relative '../app/model/reports/accessions/accession_inventory_report/accession_inventory_report.rb'
...
describe AccessionInventoryReport do
  ...
  let(:report) { AccessionInventoryReport.new({:repo_id => repo.id},
                                acc_job,
                                datab) }
