...
class Subject < Sequel::Model(:subject)
  ...
  def validate
    ...
    validates_unique([:vocab_id, :authority_id], :message => "Subject heading identifier must be unique within source")
    map_validation_to_json_property([:vocab_id, :authority_id], :authority_id)
